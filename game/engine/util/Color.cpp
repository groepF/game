...
uint8_t Color::r() const { return (this->red); }
uint8_t Color::g() const { return (this->green); }
uint8_t Color::b() const { return (this->blue); }
uint8_t Color::a() const { return (this->alpha); }